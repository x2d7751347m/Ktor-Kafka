...
//import java.util.*
//
//fun Application.configureRunningAverageStreamModule(testing: Boolean = false) {
...
//): Topology {
//
//    val ratingStream: KStream<Long, Rating> = topicStream(builder, properties)
//
//    getTopicTable(
//        ratingStream,
//        ratingsAvgTopicName,
...
//}
//
//fun topicStream(builder: StreamsBuilder, properties: Properties): KStream<Long, Rating> {
