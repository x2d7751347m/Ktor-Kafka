...
image::.doc-images/Cloud Architecture of AWS ECS with ALB.jpg[]

=== Producers and consumers writing and reading events from Kafka topics ( /messages/{group} )
image::.doc-images/kafka-producers-consumers-topics.jpg[]

/chat consists of connections only within one server.

=== Ci/cd pipeline
image::.doc-images/aws_architecture.jpg[]

== Database's table columns
image::.doc-images/Db Table.PNG[]
